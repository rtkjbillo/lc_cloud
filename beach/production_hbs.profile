rList().addSequence( _.hbs.CONFIGURATION,
                     rSequence().addInt32( _.hbs.CONFIGURATION_ID, HbsCollectorId.EXFIL )
                                .addList( _.hbs.LIST_NOTIFICATIONS, rList().addInt32( _.hbs.NOTIFICATION_ID, _.notification.NEW_PROCESS )
                                                                           ...
                                                                           .addInt32( _.hbs.NOTIFICATION_ID, _.notification.SELF_TEST_RESULT ) ) )
       ...
       .addSequence( _.hbs.CONFIGURATION,
                     rSequence().addInt32( _.hbs.CONFIGURATION_ID, HbsCollectorId.DOC_COLLECTOR )
                                .addList( _.base.EXTENSIONS, rList().addStringA( _.base.EXTENSION, ".bat" )
                                                                    ...
                                                                    .addStringA( _.base.EXTENSION, ".docm" )
                                                                    .addStringA( _.base.EXTENSION, ".docx" )
                                                                    .addStringA( _.base.EXTENSION, ".ppt" )
                                                                    .addStringA( _.base.EXTENSION, ".pptm" )
                                                                    .addStringA( _.base.EXTENSION, ".pptx" )
                                                                    .addStringA( _.base.EXTENSION, ".xlt" )
                                                                    .addStringA( _.base.EXTENSION, ".xlsm" )
                                                                    .addStringA( _.base.EXTENSION, ".xlsx" )
                                ...
                                .addList( _.base.PATTERNS, rList().addStringA( _.base.STRING_PATTERN, "/tmp/" )
                                                                  ...
                                                                  .addStringA( _.base.STRING_PATTERN, "\\windows\\" ) ) )
       .addSequence( _.hbs.CONFIGURATION,
                     rSequence().addInt32( _.hbs.CONFIGURATION_ID, HbsCollectorId.FILE_TYPE_TRACKER )
                                .addList( _.base.PATTERNS, rList().addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 1 ).addStringA( _.base.EXTENSION, ".doc" ) )
                                                                  ...
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 2 ).addStringA( _.base.EXTENSION, ".xlt" ) )
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 2 ).addStringA( _.base.EXTENSION, ".xlsm" ) )
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 2 ).addStringA( _.base.EXTENSION, ".xlsx" ) )
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 3 ).addStringA( _.base.EXTENSION, ".ppt" ) )
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 3 ).addStringA( _.base.EXTENSION, ".pptm" ) )
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 3 ).addStringA( _.base.EXTENSION, ".pptx" ) )
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 3 ).addStringA( _.base.EXTENSION, ".ppts" ) )
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 4 ).addStringA( _.base.EXTENSION, ".pdf" ) )
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 5 ).addStringA( _.base.EXTENSION, ".rtf" ) )
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 50 ).addStringA( _.base.EXTENSION, ".zip" ) )
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 51 ).addStringA( _.base.EXTENSION, ".rar" ) )
