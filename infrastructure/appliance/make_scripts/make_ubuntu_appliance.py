...
printStep( 'Install pip packages.',
           os.system( 'pip install time_uuid cassandra-driver virustotal ipaddress tld pyqrcode pypng termcolor slacker slackclient python-dateutil pyOpenSSL pexpect' ) )
