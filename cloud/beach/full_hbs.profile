       ...
       .addSequence( _.hbs.CONFIGURATION,
                     rSequence().addInt32( _.hbs.CONFIGURATION_ID, HbsCollectorId.FILE_TYPE_TRACKER )
                                .addList( _.base.PATTERNS, rList().addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 1 ).addStringA( _.base.EXTENSION, ".doc" ) )
                                                                  ...
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 1 ).addStringA( _.base.EXTENSION, ".pdf" ) )
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 1 ).addStringA( _.base.EXTENSION, ".rtf" ) )
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 1 ).addStringA( _.base.EXTENSION, ".zip" ) )
                                                                  .addSequence( _.base.RULE, rSequence().addInt8( _.base.RULE_NAME, 1 ).addStringA( _.base.EXTENSION, ".rar" ) )
